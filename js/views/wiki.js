      ...
      <article class="wiki-article collapsed" id="card-${card.id}" data-card-id="${card.id}">
        <header class="wiki-article-header">
          <div class="wiki-article-title-row">
            ...
            <span class="wiki-article-chevron"><i data-lucide="chevron-right"></i></span>
          </div>
        </header>
  ...
  function renderOverview(container) {
    ...
    const topicCards = topics
      .map((topic) => {
        ...
        const iconName = TOPIC_ICON_MAP[num] || 'library';
    ...
    container.innerHTML = `
      <div class="view-enter">
        ...
        <div class="wiki-search-wrapper">
          <i data-lucide="search" class="wiki-search-icon"></i>
  ...
  function renderTopicPage(container, topicSlug, subtopicSlug) {
      ...
      <div class="view-enter">
        ...
        <div class="wiki-controls">
          <button type="button" class="wiki-control-btn" id="wiki-toggle-all">
            <i data-lucide="chevrons-down-up" style="width: 16px; height: 16px; margin-right: 8px;"></i>
            Alle aufklappen
          </button>
        </div>
    ...
    toggleAllBtn?.addEventListener('click', () => {
      ...
      toggleAllBtn.innerHTML = allExpanded
        ? `<i data-lucide="chevrons-up-down" style="width: 16px; height: 16px; margin-right: 8px;"></i> Alle einklappen`
        : `<i data-lucide="chevrons-down-up" style="width: 16px; height: 16px; margin-right: 8px;"></i> Alle aufklappen`;
      if (window.lucide) window.lucide.createIcons();
    });
